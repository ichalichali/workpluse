...
function renderLogin() {
  ...
  <div class="auth-wrap">
    <div class="auth-hero">
      <div class="hero-logo">
        <img src="/static/ontime_logo.png" width="150" height="150" alt="OnTime" onerror="this.outerHTML='<span style=\'font-size:120px\'>&#x23F1;</span>'">
...
function renderReset() {
  ...
  <div class="auth-wrap">
    <div class="auth-hero">
      <div class="hero-logo"><img src="/static/ontime_logo.png" alt="OnTime" onerror="this.outerHTML='<span style=\'font-size:28px\'>&#x23F1;</span>'"><div class="hero-logo-text">OnTime</div></div>
...
function renderShell() {
  ...
  const isManager = role === 'manager' || role === 'hr_admin' || role === 'director' || role === 'ceo';
  ...
  <div class="app-shell">
    <aside class="sidebar">
      <div class="sidebar-logo">
        <img src="/static/ontime_logo.png" alt="OnTime" style="height:40px;object-fit:contain;background:none;padding:0;box-shadow:none" onerror="this.outerHTML='<span style=\'font-size:28px\'>&#x23F1;</span>'">
...
function roleBadge(role) {
  const map = { employee: ['badge-blue','Employee'], manager: ['badge-green','Manager'], hr_admin: ['badge-purple','HR Admin'], director: ['badge-yellow','Director'], ceo: ['badge-red','CEO'] };
...
async function downloadMyPDF() {
  ...
  printHTML(reportStyles() + `
    <div class="rpt-header">
      <div class="rpt-logo"><img src="/static/ontime_logo.png" alt="OnTime" style="height:28px;vertical-align:middle;margin-right:6px"> OnTime</div>
...
async function renderBusinessTrips() {
  // MAIN nav: always show personal trips for all roles
  return renderEmployeeTrips();
}

async function renderBusinessTripApprovals() {
  // MANAGEMENT nav: approval view for all approver roles
  const role = state.user.role;
  if (role === 'manager' || role === 'director' || role === 'ceo') return renderManagerTrips();
